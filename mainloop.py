...
def main_menu():
    ...
    #Opens mananage habit dialog
        ...
        if del_or_mod == "check":
            ...
            print(dm.get_all("names_period_lastup-streak"))
            print()
            ...
            # Selects all habits in the database that match with the user input:
            ...
            print()
            print("....List of all habits....".center(50))
            print(dm.get_all("names_description_period"))
            print()
    ...
    #This code block shows the user all available habit analyzing functionalities. The user is prompted to give an imput
    #with which then the analyze_habits function in the database module is called. Here the retuned values are printed
        ...
        print()
        print("__________________________________________________".center(50))
        print(dm.analyze_habits(analyze_input))
    ...
    #Closes the mainloop and therefore the whole program
